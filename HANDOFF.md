...
> **שלב נוכחי:** חלק 5 — שדרוג UI/UX + רספונסיביות מלאה (5A: design-tokens + breakpoints + 100dvh + safe-area; 5B: Settings redesign + Dark Mode). 308+ tests.
> **הבא בתור:** Firebase deploy · UI להגדרת מפתח Google TTS. היסטוריה מלאה: `docs/CHANGELOG.md`.
