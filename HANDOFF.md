...
- **באג 3 (לופ speak)**: ✅ PASS (re-test 2026-06-26, deploy co-board.web.app) — counter=2 (יציב לאחר לחיצה בודדת + 5 שניות המתנה), `speaking=false`, `pending=false`. התיקון (defer speak() via setTimeout(0) אחרי cancel()) פועל כצפוי.
