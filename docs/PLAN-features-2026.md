...
## חלק 1 (ראשון לביצוע) — גדלי לוח + צבעי Fitzgerald
...
## חלק 2 — תשתית חשבונות, פורטל ואישור אדמין (סעיפים 3+4)
...
## חלק 3 — תמונות אישיות + פרטיות בין משתמשים (סעיף 5, FR-005/006)
...
## חלק 4 (סעיף 6) — הצעות לשיפור נוסף
